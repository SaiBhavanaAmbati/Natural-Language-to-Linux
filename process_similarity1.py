...
vsm_dict_file = open('vsm_dict_file1.pkl', 'rb')
vsm_dict = pickle.load(vsm_dict_file)
base_avg_file = open('base_avg_file1.dat', 'rb')
base_avg = pickle.load(base_avg_file)

final_avg_file = open('final_avg_file.rd14', 'rb')
final_avg = pickle.load(final_avg_file)
base_class_file = open('base_class_file1.pkl', 'rb')
